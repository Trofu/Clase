...
public class BibliotecaTester {
    ...
    public static void main(String[] args) {
        ...
        biblio1.nuevoLibro("El archivo de la tormenta","Brandon Sanderson",6);
        biblio1.nuevoLibro("El arte de la guerra","Sun Tzu",3);
        biblio1.nuevoLibro("Alas de sangre","Rebeca Yarros",8);
        biblio1.nuevoLibro("Harry Potter El Caliz de Fuego","J.K. Rowling",3);
        biblio1.nuevoLibro("La guerra de los chips","Chris Miller",4);
        System.out.println(biblio1);
